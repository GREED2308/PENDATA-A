...
> Dataset yang digunakan {download}`Download Dataset <../play_tennis_gain_ratio.xlsx>`
...
![Workflow](gambar/decision_workflow.png)
...
![data table](gambar/data_decision.png)
...
![Table Partitioner](gambar/data_training.png) 
...
![Decision Tree Learner](gambar/decision_learner.png)
...
![Decision Tree View](gambar/tree_view.png)
...
![Decsion Tree Predictor](gambar/decision_predik.png) 
